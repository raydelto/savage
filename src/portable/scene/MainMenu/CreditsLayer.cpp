...
{
    CCLabelTTF *company = CCLabelTTF::create("COMPANY",
...
void CreditsLayer::initMenu()
{
    ...
    this->addChild(pMenu, static_cast<int>(zOrder::zIndex_2));
