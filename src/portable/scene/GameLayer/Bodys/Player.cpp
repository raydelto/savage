...
void Player::setFootpath(const Footpath& footpath)
{
    m_footpath = footpath;
    switch (m_footpath)
    {
...
void Player::update()
{
    ...
    {
        this->setFootpath(Car::Footpath::kLeft);
    }
    else if (this->getPositionX() > m_footpathPoints[3].x)
    {
        this->setFootpath(Car::Footpath::kRigth);
    }
}
