...
public:
    ...
    enum class Level{kLevel_1, kLevel_2, kLevel_3, kLevel_4, kLevel_5};
    /*!
    ...
    void changeFootpathTo(Car::Footpath changeTo);
    void putCar(Car *car);
     ...
     */
    enum class GameStatus {kPlaying, kCollided, kGameOver};
...
private:
    ...
    const Car::Footpath getNextFootPath(const Car::Footpath& currentFP) const;
