...
#ifndef _APPMACROSSSSSSSSSSSSS_H
#define _APPMACROSSSSSSSSSSSSS_H
...
//typedef struct {
//    char *bgMusicVolume{"bgMusicVolume"};
//    float bgMusicVolumeDefalutValue{0.6f};
//    char *efMusicVolume{"efMusicVolume"};
//    float efMusicVolumeDefalutValue{0.4f};
//    char *audioEnabled{"audioEnabled"};
//    bool audioEnabledDefalutValue{true};
//    char *avaliablesLevels{"avaliablesLevels"};
//    short avaliablesLevelsDefalutValue{1};
//} UserDefaultData;
